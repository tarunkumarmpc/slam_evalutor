...
def main():
    ...
    for i, t in enumerate(t_vals):
        ...
        writer.write('/slam/gt_path', serialize_message(gt_path), timestamp_ns)
        writer.write('/slam/path', serialize_message(slam_path), timestamp_ns)
